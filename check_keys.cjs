...
console.log('en length:', enKeys.length);
console.log('hi length:', hiKeys.length);
console.log('te length:', teKeys.length);
const diff = enKeys.filter(k => !teKeys.includes(k));
console.log('missing in te:', diff);
