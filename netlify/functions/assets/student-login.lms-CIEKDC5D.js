...
function LMSLogin() {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "min-h-screen grid lg:grid-cols-2 bg-secondary", children: [
      /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex bg-gradient-hero text-white p-12 flex-col justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "h-10 w-10 rounded-lg bg-gold grid place-items-center", children: /* @__PURE__ */ jsx(GraduationCap, { className: "h-5 w-5 text-navy-deep" }) }),
          /* @__PURE__ */ jsx("div", { className: "font-extrabold", children: "KMR · LMS" })
        ] }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen grid lg:grid-cols-2 bg-secondary", children: [
    /* @__PURE__ */ jsxs("div", { className: "hidden lg:flex bg-gradient-hero text-white p-12 flex-col justify-between", children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h2", { className: "text-4xl font-extrabold leading-tight", children: t("lf.headline.lms") }),
        /* @__PURE__ */ jsx("p", { className: "text-white/70 mt-4 max-w-md", children: t("lf.sub.lms") })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "text-xs text-white/50", children: "© KMR Technologies" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center p-6 lg:p-12", children: /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "w-full max-w-md bg-card rounded-3xl shadow-elegant p-8 border border-border", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-2xl font-extrabold text-navy", children: mode === "register" ? t("lf.lmsRegisterTitle") : t("lf.lms.title") }),
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground mb-6", children: mode === "register" ? t("lf.lmsRegisterSub") : t("lf.lms.sub") }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
