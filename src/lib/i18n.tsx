...
const en: Dict = {
  ...
  "courses.govt": "Skill Development Training",
  ...
  "programs.govt.title": "Skill Development",
  ...
  "why.f1.desc": "Proven track record in rural development and skill training since 2017",
  "why.f2.title": "Government Approved",
  "why.f2.desc": "NSDC, NIELIT, and other government body approvals for quality training",
  "why.f3.title": "5k+ Trained",
  "why.f3.desc": "Successfully trained over 5,000 youth with 92% placement rate",
  ...
  "bot.online": "Online",
  // About
  "about.title": "About Karthikeya Educational Society",
  ...
  "cp.govt.title": "Skill Development Training",
...
const hi: Dict = build({
  ...
  "programs.govt.title": "कौशल विकास",
  ...
  "why.f1.title": "10+ वर्ष का अनुभव",
  "why.f1.desc": "2017 से ग्रामीण विकास और कौशल प्रशिक्षण में सिद्ध ट्रैक रिकॉर्ड",
  "why.f2.title": "सरकार द्वारा स्वीकृत",
  "why.f2.desc": "गुणवत्तापूर्ण प्रशिक्षण के लिए NSDC, NIELIT, और अन्य सरकारी निकाय की मंजूरी",
  "why.f3.title": "5k+ प्रशिक्षित",
  "why.f3.desc": "92% प्लेसमेंट दर के साथ 5,000 से अधिक युवाओं को सफलतापूर्वक प्रशिक्षित किया",
  ...
  "bot.online": "ऑनलाइन",
  "about.title": "कार्तिकेय एजुकेशनल सोसाइटी के बारे में",
  ...
  "cp.govt.title": "कौशल विकास प्रशिक्षण",
...
const ta: Dict = build({
  ...
  "programs.govt.title": "திறன் மேம்பாடு",
  ...
  "why.f1.title": "10+ வருட அனுபவம்",
  "why.f1.desc": "2017 முதல் கிராமப்புற மேம்பாடு மற்றும் திறன் பயிற்சியில் நிரூபிக்கப்பட்ட சாதனை",
  "why.f2.title": "அரசு அங்கீகாரம்",
  "why.f2.desc": "தரமான பயிற்சிக்கான NSDC, NIELIT மற்றும் பிற அரசு அமைப்புகளின் அங்கீகாரம்",
  "why.f3.title": "5k+ பயிற்சி பெற்றவர்கள்",
  "why.f3.desc": "92% வேலைவாய்ப்பு விகிதத்துடன் 5,000 க்கும் மேற்பட்ட இளைஞர்களுக்கு வெற்றிகரமாக பயிற்சி அளிக்கப்பட்டுள்ளது",
  ...
  "bot.online": "ஆன்லைன்",
  "about.title": "கார்த்திகேயா கல்விச் சங்கம் பற்றி",
  ...
  "clp.overview": "பாடநெறி கண்ணோட்டம்",
  ...
  "cp.govt.title": "திறன் மேம்பாட்டு பயிற்சி",
...
const te: Dict = build({
  ...
  "programs.govt.title": "నైపుణ్యాభివృద్ధి",
  ...
  "why.title": "KES ని ఎందుకు ఎంచుకోవాలి?",
  "why.sub": "నైపుణ్యాభివృద్ధి మరియు గ్రామీణ సాధికారత కోసం మేము ఎందుకు ఉత్తమ ఎంపికయో కనుగొనండి",
  "why.f1.title": "10+ సంవత్సరాల అనుభవం",
  "why.f1.desc": "2017 నుండి గ్రామీణాభివృద్ధి మరియు నైపుణ్య శిక్షణలో నిరూపితమైన ట్రాక్ రికార్డ్",
  "why.f2.title": "ప్రభుత్వ గుర్తింపు",
  "why.f2.desc": "నాణ్యమైన శిక్షణ కోసం NSDC, NIELIT మరియు ఇతర ప్రభుత్వ సంస్థల ఆమోదాలు",
  "why.f3.title": "5k+ శిక్షణ పొందారు",
  "why.f3.desc": "92% ప్లేస్‌మెంట్ రేటుతో 5,000 మందికి పైగా యువతకు విజయవంతంగా శిక్షణ ఇచ్చాము",
  "why.f4.title": "పరిశ్రమ భాగస్వామ్యాలు",
  "why.f4.desc": "హామీ ఇవ్వబడిన ప్లేస్‌మెంట్‌ల కోసం ప్రముఖ సంస్థలతో బలమైన నెట్‌వర్క్",
  "why.f5.title": "ఉచిత శిక్షణ & వసతి",
  "why.f5.desc": "హాస్టల్ మరియు భోజన సదుపాయాలతో పూర్తిగా ఉచిత శిక్షణ",
  "why.f6.title": "అవార్డు గెలుచుకున్నది",
  "why.f6.desc": "నైపుణ్యాభివృద్ధి మరియు గ్రామీణ సాధికారతలో ప్రతిభకు గుర్తింపు పొందింది",
  "why.f7.title": "సమగ్ర అభివృద్ధి",
  "why.f7.desc": "మొత్తం వ్యక్తిత్వ వికాసం మరియు జీవిత నైపుణ్యాలపై దృష్టి",
  "why.f8.title": "బహుళ-స్థానాల ఉనికి",
  "why.f8.desc": "సులభంగా చేరుకోవడానికి తెలంగాణ అంతటా శిక్షణా కేంద్రాలు",
  "testi.eyebrow": "ప్రశంసలు",
  "testi.title": "మా విద్యార్థుల నిజమైన కథలు",
  "testi.role1": "డిజిటల్ మార్కెటింగ్",
  "testi.q1": "నిజ-ప్రపంచ ప్రాజెక్ట్‌లు, వ్యూహాత్మక ఫ్రేమ్‌వర్క్‌లు మరియు సృజనాత్మక మార్గదర్శకత్వం కలయికతో అసాధారణమైన డిజిటల్ మార్కెటింగ్ శిక్షణ. నేను అధునాతన ప్రచార నైపుణ్యాలు, కొలవగల ROI మరియు విజయవంతమైన కార్యక్రమాలకు నాయకత్వం వహించే విశ్వాసాన్ని పొందాను.",
  "testi.role2": "జనరల్ డ్యూటీ అసిస్టెంట్",
  "testi.q2": "హ్యాండ్స్-ఆన్ క్లినికల్ ప్రాక్టీస్, పేషెంట్ కమ్యూనికేషన్ మరియు అవసరమైన ప్రోటోకాల్‌లను కలిపి సమగ్ర ఆరోగ్య సంరక్షణ శిక్షణ. నేను బలమైన GDA నైపుణ్యాలను పెంపొందించుకున్నాను మరియు గౌరవనీయమైన ఫెసిలిటీలో ఉపాధి పొందాను.",
  "testi.role3": "మల్టీ స్కిల్ టెక్నీషియన్",
  "testi.q3": "ప్రాక్టికల్ వర్క్‌షాప్‌లు మరియు ఇండస్ట్రీ ప్రాక్టీస్‌లతో కఠినమైన బహుళ-నైపుణ్య సాంకేతిక శిక్షణ విభిన్న సామర్థ్యాలలో నైపుణ్యం సాధించడానికి మరియు నా సాంకేతిక పాత్రలో ఉత్పాదకతను మెరుగుపరచడానికి నాకు అధికారం ఇచ్చింది.",
  ...
  "bot.online": "ఆన్‌లైన్",
  "about.title": "కార్తికేయ ఎడ్యుకేషనల్ సొసైటీ గురించి",
  ...
  "contact.office.value": "1-6-60, బ్యాంక్ ఆఫ్ మహారాష్ట్ర పైన, నల్లబావి రోడ్, సూర్యాపేట",
  "contact.phone": "ఫోన్",
  "contact.phone.value": "+91 9966598898",
  ...
  "cp.govt.title": "నైపుణ్యాభివృద్ధి శిక్షణ",
