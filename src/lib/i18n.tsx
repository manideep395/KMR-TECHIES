...
const te: Dict = build({
  ...
  "why.f1.title": "27+ సంవత్సరాల అనుభవం",
  "why.f1.desc": "1997 నుండి గ్రామీణాభివృద్ధి మరియు నైపుణ్య శిక్షణలో నిరూపితమైన ట్రాక్ రికార్డ్",
  "why.f2.title": "ప్రభుత్వ గుర్తింపు",
  "why.f2.desc": "నాణ్యమైన శిక్షణ కోసం NSDC, NIELIT మరియు ఇతర ప్రభుత్వ సంస్థల ఆమోదాలు",
  "why.f3.title": "11,500+ శిక్షణ పొందారు",
  "why.f3.desc": "89% ప్లేస్‌మెంట్ రేటుతో 11,500 మందికి పైగా యువతకు విజయవంతంగా శిక్షణ ఇచ్చాము",
